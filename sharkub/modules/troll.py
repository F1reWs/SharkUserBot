...
end_message = '**1000-7, i died, sorry**'
...
module_list["Troll"] = {
    "hack": "Animation hack of Pentagon",
    "flip [text]": "Flip text",
    "iq": "Random show your iq",
    "drugs": "Hasn't description",
    "police": "Police animation",
    "ghoul": "1000-7 ded inside",
    "stupid": "Brain animation",
    "bombs": "Bombs in animation",
    "call": "Speaking with telegram admins animation",
    "kill": "Kill animation",
}
file_list["Troll"] = "troll.py"